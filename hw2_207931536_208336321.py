...
def find_transform(pointset1, pointset2):
    ...
    # x[0,1]=pointset1[2,1]
    # x[0,2]=1
    # x[0,6]=(pointset1[2,0]*pointset2[2,0])
    # x[0,7]=(pointset1[2,1]*pointset2[2,0])
    #
    # x[1,3]=pointset1[2,0]
    # x[1,4]=pointset1[2,1]
    # x[1,5]=1
    # x[1,6]=(pointset1[2,0]*pointset2[2,1])
    # x[1,7]=(pointset1[2,1]*pointset2[2,1])
    # #########################################
    # x[2, 0] = pointset1[3, 0]
    # x[2, 1] = pointset1[3, 1]
    # x[2, 2] = 1
    ...
    # x[6, 1] = pointset1[5, 1]
    # x[6, 2] = 1
    # x[6, 6] = (pointset1[5, 0] * pointset2[5, 0])
    # x[6, 7] = (pointset1[5, 1] * pointset2[5, 0])
    #
    # x[7, 3] = pointset1[5, 0]
    # x[7, 4] = pointset1[5, 1]
    # x[7, 5] = 1
    # x[7, 6] = (pointset1[5, 0] * pointset2[5, 1])
    # x[7, 7] = (pointset1[5, 1] * pointset2[5, 1])
